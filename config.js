...
const init_phones = ["STAGE"],                      // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      watermark_image_url = "xtreme_logo.png",   // Optional. If image file is in same directory as config, can be just the filename
      page_title = "XtremeEarsGraph",                     // Optional. Appended to the page title if share URLs are enabled
